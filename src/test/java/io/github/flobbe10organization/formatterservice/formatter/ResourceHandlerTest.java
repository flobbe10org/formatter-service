...
public class ResourceHandlerTest {
    ...
    public static final String TEST_TEMPLATE = "./src/test/java/io/github/flobbe10organization/formatterservice/testdata/testTemplate.json";

    public static final String NEW_TEST_TEMPLATE = "./src/test/java/io/github/flobbe10organization/formatterservice/testdata/newTestTemplate.json";

    public static final String CONTRACT_TEMPLATE = "./src/test/java/io/github/flobbe10organization/formatterservice/testdata/contractTemplate.json";
