...
/**
 * Class that generates example values for all elements in a template.
 *
...
public class ExampleGenerator {
    ...
    public static void build(Template template) {
        template.getSections().forEach(ExampleGenerator::buildSection);
    }

    private static void buildSection(Section section) {
        section.getElements().forEach(SectionElement::generateExample);
    }
}
